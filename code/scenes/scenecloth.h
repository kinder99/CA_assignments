...
protected:
    ...
    // physics
    IntegratorRK4 integrator; // TODO: pick a better one
    ...
    //fixed particles
    const std::vector<std::string> situations = {
        "Top", "Top Corners", "All Corners", "None"
    };
    std::string situation = "None";

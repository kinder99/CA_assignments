...
double WidgetProjectiles::getLinear1() const {
    return ui->linear1->value();
}

double WidgetProjectiles::getLinear2() const {
    return ui->linear2->value();
}

double WidgetProjectiles::getQuadratic1() const {
    return ui->quadratic1->value();
}

double WidgetProjectiles::getQuadratic2() const {

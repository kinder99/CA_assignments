    ...
    , ui(new Ui::MainWindow)
{
    ...
    connect(ui->actionSceneN_body,      &QAction::triggered, this, [=](void){ changeScene(new SceneNBody()); });
    ...
    connect(ui->actionSceneSPH,      &QAction::triggered, this, [=](void){ changeScene(new SceneSPH()); });
